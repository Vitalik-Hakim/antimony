...
class leveldb_error: public std::runtime_error {
    public: leveldb_error(const std::string & msg): std::runtime_error(msg) {}
};
...
class CLevelDBBatch {
    ...
    public:
        template < typename K, typename V > void Write(const K & key,
            const V & value) {
...
class CLevelDB {
    ...
    template < typename K, typename V > bool Write(const K & key,
        const V & value, bool fSync = false) throw (leveldb_error) {
        CLevelDBBatch batch;
