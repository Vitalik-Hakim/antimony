...
template < unsigned int BITS >
    class base_uint {
        ...
        void SetHex(const char * psz) {
            ...
            // hex string to uint
            static
            const unsigned char phexdigit[256] = {
                0,
                0,
                0,
                0,
...
class uint160: public base_uint160 {
    public: typedef base_uint160 basetype;
...
inline bool operator < (const base_uint160 & a,
    const uint160 & b) {
...
inline bool operator < (const uint160 & a,
    const base_uint160 & b) {
    return (base_uint160) a < (base_uint160) b;
}
inline bool operator <= (const uint160 & a,
...
class uint256: public base_uint256 {
    public: typedef base_uint256 basetype;
...
inline bool operator < (const base_uint256 & a,
    const uint256 & b) {
...
inline bool operator < (const uint256 & a,
    const base_uint256 & b) {
    return (base_uint256) a < (base_uint256) b;
}
inline bool operator <= (const uint256 & a,
